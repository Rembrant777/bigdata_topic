...
import org.emma.spark.streaming.topic.redis.Cache;
import org.emma.spark.streaming.topic.redis.RedisBackendCache;
...
public class RedisBackendCacheIT {
    ...
    private static ThreadLocal<JedisPool> jedis;
